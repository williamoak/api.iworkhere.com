...
export type WarframeDTO = {
    ...
    current_passives: any | null;

    max_abilities: number | null;
    current_abilities: any | null;

    max_mods: number | null;
    current_mods: any | null;

    max_aura_mods: number | null;
    current_aura_mods: any | null;

    max_exilus_mods: number | null;
    current_exilus_mods: any | null;

    max_arcanes: number | null;
    current_arcanes: any | null;

    max_shards: number | null;
    current_shards: any | null;

    weapons_loadout: any | null;
};
