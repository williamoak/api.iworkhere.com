...
<head>
    ...
    <style>
        body {
            background-color: #d8eafa; /* Pastel blue */
...
<body>
    <div class="card">
            ...
            : `
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', () => {
                        ...
                        document.getElementById('eula-btn-readme').onclick = () => loadDocument('/v1/readme', 'README');
        ...
        <div class="docs-panel" style="display: flex; justify-content: center; gap: 10px;">
            ...
            <button type="button" id="eula-btn-readme" title="View the README">README</button>
        </div>
    </div>
</body>
</html>
