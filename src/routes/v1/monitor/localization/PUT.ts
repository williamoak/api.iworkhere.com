 ...
 * @summary Create or update a localization record via monitor endpoint.
 *
 * @description
 * Inserts or updates a localization record identified by (slug, lang).
 * This endpoint is specifically used for persisting new translations generated by the client.
...
export function makePutLocalizationHandler(repo: LocalizationWriteRepository = dbLocalizationWriteRepository) {
    return async function PUT(req: Request, res: Response) {
        try {
            ...
            logger.error('PUT /v1/monitor/localization error:', err);
